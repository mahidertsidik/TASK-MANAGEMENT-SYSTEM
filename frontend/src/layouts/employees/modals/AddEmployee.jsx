            ...
            <ModalContent >
                <form onSubmit={handleSubmit}>
                    ...
                    <ModalBody>
                        ...
                        <Input mt={3} mb={3} type='text' required placeholder='Position' name='position' value={formData.position} onChange={handleChange} />
                        <Input mt={3} mb={3} type='text' required placeholder='Department' name='department' value={formData.department} onChange={handleChange} />
                        ...
                        <div className='priority-container'>
                            ...
                            <Tag
                                size='lg'
                                cursor={'pointer'}
                                colorScheme={formData.status === 'inactive' ? 'yellow' : 'gray'}
                                borderRadius='full'
                                onClick={() => handleStatusClick('inactive')}
                            >
                                <p className='tag-text'>Inactive</p>
                            </Tag>
                        </div>
                        <div className='priority-container'>
                            <p>Gender: </p>
